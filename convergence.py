...
from ema_workbench import (perform_experiments, CategoricalParameter,
                           RealParameter, ScalarOutcome, ema_logging, MultiprocessingEvaluator, SequentialEvaluator, save_results)
...
if __name__ == "__main__":
    ...
    convergence_metrics = [HyperVolume(minimum=[0.1,8.48,927.7,7.12], maximum=[0.23, 8.52,928,7.2]),
                        EpsilonProgress()] #klopt niet
    ...
    results.to_excel('./Data/results_convergence_4.xlsx')
    convergence.to_excel('./Data/conv_convergence_4.xlsx')
